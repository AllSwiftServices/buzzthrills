    ...
    const info = await transporter.sendMail({
      ...
      html: `
        <div style="font-family: sans-serif; padding: 40px; text-align: center; background: #fff; color: #000;">
          <h1 style="color: #FF2E63; font-size: 32px; font-weight: 900; margin-bottom: 20px;">Welcome to the Squad! 🦸‍♂️</h1>
          <p style="font-size: 16px; color: #666; margin-bottom: 30px;">Your magic activation code is:</p>
          <div style="font-size: 54px; font-weight: 900; letter-spacing: 12px; padding: 30px; background: #f8f8f8; border-radius: 20px; color: #FF2E63; display: inline-block; margin-bottom: 30px;">
            ${otp}
          </div>
          <p style="color: #999; font-size: 14px;">This code expires in 10 minutes. Go use it to activate your Mission Control dashboard!</p>
