...
export const CALL_SERVICES: Record<string, CallService> = {
  celebratory: {
    ...
    basePrice: 2500,
    tiers: [
      { variant: "standard", price: 2500, label: "Standard" },
      { variant: "prank", price: 3000, label: "Prank Inclusive" },
      { variant: "music", price: 3500, label: "Music Thrills Inclusive" },
      { variant: "both", price: 5000, label: "Prank + Music Thrills" },
    ],
    icon: "Star",
  },
  appreciatory: {
  ...
  request: {
    ...
    basePrice: 2500,
    tiers: [{ variant: "standard", price: 2500, label: "Standard" }],
    icon: "HelpCircle",
  },
  encouragement: {
    id: "encouragement",
    ...
    tiers: [
      { variant: "standard", price: 2500, label: "Standard" },
      { variant: "music", price: 4000, label: "Reach Out Calls / Music Thrills" },
    ],
    icon: "Sun",
  },
  self_love: {
  ...
  shoot_your_shot: {
    ...
    basePrice: 4000,
    tiers: [{ variant: "standard", price: 4000, label: "Standard" }],
    icon: "Target",
  },
  period_care: {
    id: "period_care",
    ...
    tiers: [
      { variant: "standard", price: 3000, label: "Standard" },
      { variant: "music", price: 5000, label: "Music Thrills Inclusive" },
    ],
    icon: "Moon",
  },
  lullaby: {
    ...
    basePrice: 3500,
    tiers: [
      { variant: "one-off", price: 3500, label: "One Off" },
