...
import { Mail, Volume2, QrCode, Heart, Star, Sparkles, Send, Zap, MessageSquareQuote } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <Reveal delay={0.3}>
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link href="/digital-letters/create" className="px-8 py-4 sm:px-12 sm:py-6 rounded-3xl gradient-bg text-white font-bold text-base sm:text-xl hover:scale-105 transition-all shadow-huge flex items-center justify-center gap-3 active:scale-95">
                Create a Letter
                <Send size={24} />
              </Link>
            </div>
      ...
      <section className="py-24 px-6 relative">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            { title: "Legacy Archiving", desc: "Every letter is hosted on a permanent, private link. A timeless gift they can revisit for years.", icon: <QrCode size={24} /> }
          ].map((f, i) => (
