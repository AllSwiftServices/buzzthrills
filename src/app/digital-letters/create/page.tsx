    ...
    <main className="min-h-screen bg-background pt-28 pb-20 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10 px-4">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full glass border border-accent/20 mb-6 text-[10px] font-bold text-accent uppercase tracking-[0.4em] italic">
            Digital Letter
          </div>
