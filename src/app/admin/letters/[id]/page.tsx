          ...
          {publishShareUrl && (
            <div className="flex gap-2 mt-2">
              <input
                ...
                className="flex-1 bg-foreground/5 border border-foreground/10 rounded-xl px-3 py-2 text-xs font-mono text-foreground/70 outline-none"
              />
              <button
                ...
                <button
                  ...
                  className={`p-4 rounded-2xl border-2 flex flex-col items-start gap-1 transition-all hover:scale-[1.02] active:scale-95 disabled:cursor-default ${
                    isActive
                      ...
                      : "border-foreground/10 bg-foreground/[0.02] hover:bg-foreground/5 text-foreground/40"
                  }`}
                >
